			       ...
			       int argno)
{
  ...
  if (type->name () == NULL)
    {
      AMD_PyErr_SetString(AMD_PyExc_RuntimeError, _("Null type name."));
      return NULL;
    }
  ...
  if (! info)
    {
      AMD_PyErr_SetString(AMD_PyExc_RuntimeError, err.c_str ());
      return NULL;
    }
  demangled = info->tree;
  ...
  if (demangled->type != DEMANGLE_COMPONENT_TEMPLATE)
    {
      AMD_PyErr_SetString(AMD_PyExc_RuntimeError, _("Type is not a template."));
      return NULL;
    }
