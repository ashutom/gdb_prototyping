...
inferior_to_inferior_object (struct inferior *inferior)
{
  ...
  if (!inf_obj)
	...
	return nullptr;
      ...
      /* AMD_PyObject_New initializes the new object with a refcount of 1.  This
...
thread_to_thread_object (thread_info *thr)
{
  ...
  AMD_PyErr_SetString((AMD_PyExc_SystemError),
...
infpy_set_args (PyObject *self, PyObject *value, void *closure)
{
  ...
  if (!inf->inferior)
    {
      AMD_PyErr_SetString(AMD_PyExc_RuntimeError, _("Inferior no longer exists."));
      return -1;
    }
